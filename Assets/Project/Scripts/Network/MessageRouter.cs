...
namespace Project.Scripts.Network
{
    ...
    public class MessageRouter
    {
        ...
        private Dictionary<string, List<MessageHandler>> messageHandlers = new();
        ...
        public void RegisterHandler(string messageType, MessageHandler handler)
        {
            ...
            if (!messageHandlers.ContainsKey(messageType)) messageHandlers[messageType] = new List<MessageHandler>();
        ...
        public void UnregisterHandler(string messageType, MessageHandler handler)
        {
            ...
            if (messageHandlers.ContainsKey(messageType))
            {
                ...
                if (messageHandlers[messageType].Count == 0) messageHandlers.Remove(messageType);
            }
        }
        ...
        public void RouteMessage(string jsonMessage)
        {
            ...
            {
                // JSON'ı parse et
                var messageObj = JObject.Parse(jsonMessage);
        ...
        {
            if (messageHandlers.ContainsKey(messageType)) messageHandlers.Remove(messageType);
        }
    }
}