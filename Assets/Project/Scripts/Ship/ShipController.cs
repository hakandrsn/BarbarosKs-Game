...
namespace BarbarosKs.Ship
{
    ...
    public class ShipController : MonoBehaviour
    {
        ...
        [SerializeField] private float sailDeployment;

        [Header("Ses Efektleri")] [SerializeField]
        ...
        private void UpdateVisuals()
        {
            ...
            if (shipModel != null)
            {
                ...
                var healthPercentage = (float)currentHullDurability / maxHullDurability;

                // Hasara göre efektleri aktifleştir/deaktifleştir
                if (shipDamageVFX != null) shipDamageVFX.SetActive(healthPercentage < 0.5f);
            }
        }
        ...
        private void OnShipDestroyed()
        {
            ...
            if (shipDestroyVFX != null) shipDestroyVFX.SetActive(true);
        ...
        private void CleanupDestroyedShip()
        {
            ...
            if (!isLocalShip) Destroy(gameObject);
        ...
        public void RepairShip(int repairAmount)
        {
            ...
            if (currentHullDurability > maxHullDurability) currentHullDurability = maxHullDurability;
